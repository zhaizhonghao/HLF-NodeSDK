...
// Main function
exports.initCredStore = async function(org,user){
...
function getCertPath(org, user) {
    ...
    var certPath = CRYPTO_CONFIG_PEER_ORGANIZATIONS + "/" + org + ".com/users/" + user + "@" + org + ".com/msp/signcerts/" + user + "@" + org + ".com-cert.pem"
    return certPath
}
...
function getPrivateKeyPath(org, user) {
    ...
    var pkFolder = CRYPTO_CONFIG_PEER_ORGANIZATIONS + "/" + org + ".com/users/" + user + "@" + org + ".com/msp/keystore"
